<div class="report-section">
    ...
    <h6 class="fw-semibold mb-2"><i class="bi bi-boxes text-primary me-1"></i>Current Stock Levels</h6>
            ...
            <table class="table table-hover table-sm align-middle mb-0 app-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center text-muted">{{ $product->sold_count }}</td>
                        <td class="text-end" style="white-space:nowrap">₱{{ number_format($product->cost, 2) }}</td>
                ...
                <tfoot>
                    <tr class="fw-semibold">
                        ...
                        <td class="text-center">{{ $totalStockUnits }}</td>
                        <td class="text-center">{{ $inventorySnapshot->sum('pending_count') }}</td>
                        <td class="text-center">{{ $inventorySnapshot->sum('sold_count') }}</td>
                        <td></td>
                        <td class="text-end text-primary">₱{{ number_format($totalStockValue, 2) }}</td>
                        <td></td>
                    </tr>
                </tfoot>
                @endif
